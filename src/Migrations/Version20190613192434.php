 ...
 */
final class Version20190613192434 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE booking_request CHANGE contact_name contact_name VARCHAR(100) NOT NULL');
        $this->addSql('ALTER TABLE booking_request CHANGE contact_email contact_email VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE booking_request CHANGE contact_phone contact_phone VARCHAR(200)');
        $this->addSql('ALTER TABLE booking_request CHANGE comments comments VARCHAR(1000) DEFAULT NULL');
